            ...
            steps {
                script {
                    paramsAsJson.each{conflict ->
                        ...
                        body += System.getProperty('line.separator')
                        body += "This mail was automatically generated by Jenkins Job '${BUILD_URL}'"

                        echo "going to send mail about \"Patch Conflict(s) between Patch ${p1Number} and ${p2Number}\""
                        emailext to: conflict.emailAdress.join(";"), from: "it.architektur@apgsga.ch" , subject: "${env.PIPELINE_MAIL_ENV} - WARNING / Patch Conflict(s) between Patch ${p1Number} and ${p2Number}", body: "${body}"
                    }
                }
            }
        }
